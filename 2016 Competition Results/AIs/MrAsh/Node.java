...
public class Node {
  ...
  public Node(FrameData frameData, Node parent, LinkedList<Action> myActions,
      ...
      CommandCenter commandCenter, LinkedList<Action> selectedMyActions,Action oppA) {
    this(frameData, parent, myActions, oppActions, gameData, playerNumber, commandCenter,oppA);
    this.selectedMyActions = selectedMyActions;
  }

  public Node(FrameData frameData, Node parent, LinkedList<Action> myActions,
      LinkedList<Action> oppActions, GameData gameData, boolean playerNumber,
      CommandCenter commandCenter,Action oppA) {
	this.oppA = oppA;
